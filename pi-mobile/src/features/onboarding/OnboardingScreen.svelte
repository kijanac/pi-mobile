        ...
        <CarouselContent class="h-full -ml-3">
          ...
          <CarouselItem class="min-h-0 overflow-y-auto pl-3">
            <OnboardingPanel eyebrow="step 2" title="tailscale setup">
              ...
              <button type="button" onclick={() => onboarding.setShowAdvanced(!onboarding.showAdvanced)} class="text-left text-[11px] text-[color:var(--color-accent)] active:opacity-70">
          ...
          <CarouselItem class="min-h-0 overflow-y-auto pl-3">
            <OnboardingPanel eyebrow="step 3" title="copy cloud-init">
              ...
              <div>
                ...
                <Textarea id="cloud_init" readonly value={onboarding.cloudInit} rows={15} class="min-h-0 resize-none bg-[color:var(--color-bg)] font-mono text-[10.5px] leading-relaxed" />
              </div>
          ...
          <CarouselItem class="min-h-0 overflow-y-auto pl-3">
            <OnboardingPanel eyebrow="step 5" title="provider sign-in">
              ...
              {#if onboarding.authError}
                <p class="rounded-[var(--radius-md)] border border-[color:var(--color-border)] bg-[color:var(--color-bg)] p-2 text-[11px] text-[color:var(--color-danger)]">{onboarding.authError}</p>
              {/if}
